...
class SSMix:
    ...
    def __call__(self, input1, input2, target1, target2, length1, length2, max_len):
        ...
        input2_saliency, input2_emb, _ = get_saliency(self.model, self.optimizer, input2, target2)
    ...
    def ssmix(self, batch_size, input1, input2, length1, length2, saliency2, target1, max_len):
        ...
        saliency1, _, _ = get_saliency(self.model, self.optimizer, inputs_aug, target1)
        ratio = torch.ones((batch_size,)).cuda()
